...
url_online = "https://luka-baby-prerelease.ling.cn/robot-login"
url_nlu_chat = "https://luka-baby-prerelease.ling.cn/nlu/chat"

udid = "5C7JYEY2"
api_version = "v1.1"
Language = "zh_CN"
accept = "application/vnd.luka-baby." + str(api_version) + "+json"
    ...
    with open(inputfile, "r") as f:
        for i in f.readlines():
            ...
            data = {
                "data": {
                    "type": "nlu", "attributes": {
                        "user_id": "luka_02", "device_type": "lukababy", "words": words, "machine_sentence": "",
                        "initiative": bool(0),
                        "use_chitchat": 1
                    }
                }
